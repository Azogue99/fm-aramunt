...
export const BasquetPanel: React.FC = () => {
  ...
  useEffect(() => {
    const q = query(collection(db, 'teams'), where('tournament', '==', 'basquet'));
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-orange-600 text-white shadow-sm py-4 px-6 flex justify-between items-center">
        <h1 className="text-xl font-bold">Admin: Bàsquet 3x3</h1>
        <div className="flex gap-4">
          <Link to="/" className="text-sm bg-orange-500 px-3 py-1 rounded hover:bg-orange-400">Inici</Link>
